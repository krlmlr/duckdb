...
static constexpr ExtensionFunctionEntry EXTENSION_FUNCTIONS[] = {
    ...
    {"icu_collate_blo", "icu", CatalogType::SCALAR_FUNCTION_ENTRY},
...
static constexpr ExtensionEntry EXTENSION_SETTINGS[] = {
    ...
    {"mysql_enable_filter_pushdown", "mysql_scanner"},
    {"mysql_enable_predicate_analyzer", "mysql_scanner"},
    ...
    {"parquet_prefetch_column_gap", "parquet"},
